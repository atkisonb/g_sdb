...
class UserAccountsControllerTest < ActionController::TestCase
  ...
  test "should create user_account" do
    assert_difference('UserAccount.count') do
      post :create, user_account: { account_type_id: @user_account.account_type_id, user_account_number: @user_account.user_account_number, user_id: @user_account.user_id }
    end
  ...
  test "should update user_account" do
    patch :update, id: @user_account, user_account: { account_type_id: @user_account.account_type_id, user_account_number: @user_account.user_account_number, user_id: @user_account.user_id }
    assert_redirected_to user_account_path(assigns(:user_account))
  end
