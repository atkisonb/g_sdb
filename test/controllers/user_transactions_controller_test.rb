...
class UserTransactionsControllerTest < ActionController::TestCase
  ...
  test "should create user_transaction" do
    assert_difference('UserTransaction.count') do
      post :create, user_transaction: { fund_id: @user_transaction.fund_id, issued_nav_shares: @user_transaction.issued_nav_shares, transaction_dollar_amount: @user_transaction.transaction_dollar_amount, user_account_id: @user_transaction.user_account_id }
    end
  ...
  test "should update user_transaction" do
    patch :update, id: @user_transaction, user_transaction: { fund_id: @user_transaction.fund_id, issued_nav_shares: @user_transaction.issued_nav_shares, transaction_dollar_amount: @user_transaction.transaction_dollar_amount, user_account_id: @user_transaction.user_account_id }
    assert_redirected_to user_transaction_path(assigns(:user_transaction))
  end
