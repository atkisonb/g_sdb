...
class FundTransactionsControllerTest < ActionController::TestCase
  ...
  test "should create fund_transaction" do
    assert_difference('FundTransaction.count') do
      post :create, fund_transaction: { amount: @fund_transaction.amount, fund_id: @fund_transaction.fund_id, market_order_id: @fund_transaction.market_order_id, market_shares: @fund_transaction.market_shares, stock_id: @fund_transaction.stock_id }
    end
  ...
  test "should update fund_transaction" do
    patch :update, id: @fund_transaction, fund_transaction: { amount: @fund_transaction.amount, fund_id: @fund_transaction.fund_id, market_order_id: @fund_transaction.market_order_id, market_shares: @fund_transaction.market_shares, stock_id: @fund_transaction.stock_id }
    assert_redirected_to fund_transaction_path(assigns(:fund_transaction))
  end
